...
sap.ui.define([
		...
		return BaseController.extend("CGI.ReconResults.controller.Detail", {
			...
			_onObjectMatched : function (oEvent) {
				...
				this.getModel().metadataLoaded().then( function() {
					var sObjectPath = this.getModel().createKey("RESULTS", {
						PIID :  sObjectId
					});
			...
			_onBindingChange : function () {
				...
				var sPath = oElementBinding.getPath(),
					...
					sObjectId = oObject.PIID,
					sObjectName = oObject.ADDR_CTRY_ERROR,
